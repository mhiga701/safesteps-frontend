...
export default function ReportObstacle() {
  ...
  const [intersection1, setSelectedIntersection1] = useState(
      ...
      if (message === "") {
        if (
          ...
          try {
            ...
            console.log(
              `Report: ${reports}, ${message} at ${intersection1} on ${day}, at ${time}`
            );
          } catch (e) {
      ...
      <View>
        ...
        <View style={{ top: 110 }}>
          <Dropdown
            ...
            value={intersection1}
            onChange={(intersection1) =>
              setSelectedIntersection1(intersection1.label)
            }
          />
        </View>
