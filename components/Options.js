  ...
  return (
    <>
      ...
      <View style={[styles.ReportContainer, { top: 70, height: 170 }]}>
        <View style={{ top: -120 }}>
          <Text style={[styles.Present, { textAlign: "center", marginTop: 0 }]}>
            Are You In Immediate Danger?
          </Text>
          <Text style={[styles.Options, { top: 140 }]}>
            We strongly advise you to call 911 if the issue has not been
            addressed head-on yet.
          </Text>
          <TouchableOpacity
            style={[
              styles.emergencyButton,
              { bottom: -100, right: -70, width: 150 },
            ]}
          >
            <Text style={[styles.ReportText, { color: "white" }]}>
              Call 911
            </Text>
          </TouchableOpacity>
        </View>
