...
export default function RPage() {
    ...
    return (
        ...
        <Text style={{color: '#f2f2f2', fontSize: 20, fontWeight: "700", marginTop: 80, marginLeft: 20, marginBottom: 20, fontFamily: "Montserrat-Bold", position: "absolute"}}>Report</Text>
        <Text style={{fontFamily: "Bitter-Regular",  marginTop: 120, marginLeft: 20, marginBottom: 10,color: '#f2f2f2', position: 'absolute', fontSize: 15}}>Help alert other users by reporting </Text>
        <Text style={{fontFamily: "Bitter-Regular",  marginTop: 135, marginLeft: 20, color: '#f2f2f2', position: 'absolute', fontSize: 15}}>a traffic accident or road obstacle</Text>
