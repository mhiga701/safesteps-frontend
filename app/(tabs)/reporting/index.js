    ...
    <>
      ...
      <View style={styles.reportingContainer}>
        ...
        {/* <View style={[styles.ReportContainer, { top: 15, height: 120 }]}>
          ...
          <TouchableOpacity onPress={() => router.push("/reporting/accident")}>
            <Text style={styles.callButtonText}>
              Traffic Accident (Deprecated)
            </Text>
            <Text style={[styles.trafficText, { right: -12 }]}>
        ...
        {/* <View style={[styles.ReportContainer, { bottom: -25, height: 120 }]}>
            ...
            >
              <Text style={[styles.callButtonText, { left: -10 }]}>
                File a Report (Deprecated)
              </Text>
              <Text style={styles.trafficText}>
                Help Keep Other Users Notified
              </Text>
            </TouchableOpacity>
          </View> */}
        ...
        <View style={[styles.ReportContainer, { bottom: -25, height: 120 }]}>
          <View style={{ left: -18 }}>
            <Ionicon name="eye" size={30} color="#5787f5" />
          </View>

          <TouchableOpacity
            onPress={() => router.push("/reporting/reportform")}
          >
            <Text style={[styles.callButtonText, { left: -10 }]}>
              File a Report
            </Text>
